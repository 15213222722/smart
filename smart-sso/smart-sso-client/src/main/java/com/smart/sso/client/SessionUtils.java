...
public class SessionUtils {
	 ...
	 * 其他session共享
	 */
	public static final String OTHER_SESSION = "_otherSession";
	...
	public static OtherSession getOtherSession(HttpServletRequest request) {
		return (OtherSession)WebUtils.getSessionAttribute(request,OTHER_SESSION);
	}
	
	public static void setOtherSession(HttpServletRequest request, OtherSession otherSession) {
		WebUtils.setSessionAttribute(request, OTHER_SESSION, otherSession);
	}
	
	public static void invalidate(HttpServletRequest request){
		setSessionUser(request, null);
		setSessionPermission(request, null);
		setOtherSession(request, null);
	}
}