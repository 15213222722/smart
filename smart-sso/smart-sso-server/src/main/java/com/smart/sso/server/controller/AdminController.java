...
public class AdminController {
	...
	public String execute(HttpServletRequest request, Model model) {
		...
		OtherSession otherSession = new OtherSession("ccccc");
		SessionUtils.setOtherSession(request, otherSession);
		System.out.println("admin:"+SessionUtils.getOtherSession(request).getSessionValue());
		return "/admin";
	}
